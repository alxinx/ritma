...
const mailAspirante = async ({ emailAspirante, nombreAspirante }) => {
    ...
    await transport.sendMail({
        ...
        to: emailAspirante,
        subject: 'RITMA — Solicitud Recibida',
        text: 'Hemos recibido tu solicitud de acceso a RITMA.',
        html: `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <title>RITMA - Solicitud Recibida</title>
    <style>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="600" style="border-collapse: collapse; background-color: #000000; border: 1px solid #1a1a1a;">
                    ...
                    <tr>
                        <td align="center" style="padding: 0 40px 30px 40px;">
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="background-color: rgba(201, 218, 43, 0.05); border: 1px solid #C9DA2B; padding: 30px;">
                                <tr>
                                    <td align="center">
                                        <h1 style="color: #C9DA2B; font-weight: bold; text-transform: uppercase; letter-spacing: 3px; font-size: 26px; margin: 0;">Recibimos Tu Solicitud</h1>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td align="center" style="padding: 0 50px 15px 50px;">
                            <p style="color: rgba(255,255,255,0.8); font-size: 16px; line-height: 1.7; margin: 0; text-align: center;">
                                Nuestro equipo t&eacute;cnico est&aacute; evaluando la viabilidad de tu aplicaci&oacute;n para asegurar la exclusividad de la red.
                            </p>
                        </td>
                    </tr>
                    <tr>
                        <td align="center" style="padding: 0 50px 35px 50px;">
                            <p style="color: rgba(255,255,255,0.45); font-size: 13px; line-height: 1.6; margin: 0; text-align: center;">
                                Un representante de RITMA se pondr&aacute; en contacto contigo a la brevedad a trav&eacute;s de WhatsApp o correo electr&oacute;nico para brindarte acceso oficial.
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td align="center" style="padding: 0 60px 30px 60px;">
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="background-color: #0a0a0a; border: 1px solid rgba(255,255,255,0.1); border-radius: 8px; padding: 20px;">
                                <tr>
                                ...
                                <tr>
                                    <td style="padding: 5px 25px 15px 25px;">
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                            <tr>
                                                <td style="color: #ffffff; font-size: 16px; font-weight: bold;">Evaluaci&oacute;n en Proceso</td>
                                                <td align="right" style="color: #C9DA2B; font-size: 16px; font-weight: bold;">65%</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                                    ...
                                    <td style="padding: 0 25px 15px 25px;">
                                        <table border="0" cellpadding="0" cellspacing="4" width="100%">
                                            <tr>
                                                ...
                                                <td style="width: 25%; height: 6px; background-color: #C9DA2B; border-radius: 3px;"></td>
                                                <td style="width: 25%; height: 6px; background-color: #C9DA2B; border-radius: 3px;"></td>
                                                <td style="width: 25%; height: 6px; background-color: #333333; border-radius: 3px;"></td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                    ...
                    <!-- TARJETAS: TIEMPO ESTIMADO + PRIORIDAD -->
                    <tr>
                        <td align="center" style="padding: 0 60px 40px 60px;">
                            <table border="0" cellpadding="0" cellspacing="12" width="100%">
                                <tr>
                                    <td width="50%" align="center" style="background-color: #0a0a0a; border: 1px solid rgba(201, 218, 43, 0.2); border-radius: 8px; padding: 20px;">
                                        <p style="color: rgba(255,255,255,0.4); font-size: 10px; text-transform: uppercase; letter-spacing: 2px; margin: 0 0 8px 0; font-weight: bold;">Tiempo Estimado</p>
                                        <p style="color: #ffffff; font-size: 22px; font-weight: bold; margin: 0;">24-48 Horas</p>
                                    </td>
                                    <td width="50%" align="center" style="background-color: #0a0a0a; border: 1px solid rgba(255,255,255,0.1); border-radius: 8px; padding: 20px;">
                                        <p style="color: rgba(255,255,255,0.4); font-size: 10px; text-transform: uppercase; letter-spacing: 2px; margin: 0 0 8px 0; font-weight: bold;">Prioridad</p>
                                        <p style="color: #C9DA2B; font-size: 22px; font-weight: bold; margin: 0;">ALTA</p>
                                    </td>
                                </tr>
                            </table>
                        </td>
