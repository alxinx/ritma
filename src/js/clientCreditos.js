...
;(function () {
    document.addEventListener('DOMContentLoaded', () => {
        ...
        document.getElementById('bold-overlay')?.addEventListener('click', cerrarModalBold);
        ...
        function abrirModalBold(pack) {
            ...
            if (pack) {
                ...
                // Sin preselección — limpiar estado de todas las tarjetas
                modalBold.querySelectorAll('.modal-pack-card').forEach(card => {
